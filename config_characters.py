...
# Enemies
firegoblin = Character("Fire Goblin", Element.FIRE, Row.FRONT, Column.LEFT, 1, 300, 20, 10, poke)
airgoblin = Character("Air Goblin", Element.AIR, Row.BACK, Column.RIGHT, 1, 300, 20, 10, poke)
watergoblin = Character("Water Goblin", Element.WATER, Row.MID, Column.RIGHT, 1, 300, 20, 10, sneaky_poke)
orc = Character("Orc", Element.EARTH, Row.FRONT, Column.RIGHT, 1, 700, 35, 20, slash)
orc2 = Character("Orc2", Element.EARTH, Row.MID, Column.LEFT, 1, 700, 35, 20, slash)
